# Codex Batch 4 — spouse-01 h-d3 + w-2(h-d3) 다국어 sync

## 폴더 목적

Codex worktree 통째 업로드용 self-contained 묶음.

## 폴더 파일 (총 5개)

| # | 파일 | 역할 |
|---|---|---|
| 1 | [codex-multilang-sync.md](codex-multilang-sync.md) | **주 의뢰서** — 22 entry × 3 lang = 66 entry sync |
...
sync.md §0~§6 따라.
branch: `codex/spouse01-cycle2-batch4-multilang`
