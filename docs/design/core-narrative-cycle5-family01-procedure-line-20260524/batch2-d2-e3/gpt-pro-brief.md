...
**Cycle 7 신규 정책 핵심:**
- 재판관 발화에 감정·가치 어휘 X ("선을 넘다", "흐름", "낙인" 회피)
- 사실·행위·선후관계 중심 어휘 사용 ("정황", "선후관계", "관련")
- "반증/그 X" → "관련 X" 중립 표현
- 평가성 결정 어휘 ("충분히 정리됐다", "필요하다고 봅니다") 회피하고 사실 진술 ("관련 자료가 모였다", "정황이 정리됐다") 권장
...
**가이드:**
- 판사 auto (Cycle 7 정책 적용 — 평가성 어휘 회피): "어머니 판단 능력 영역과는 별도로, 공증 절차의 진행 경위에 대한 관련 자료가 모였습니다. 본 법정에 공증 절차의 개입을 쟁점으로 등록합니다." (이전 "충분히 살필 필요가 있다고 봅니다" → 사실 진술로 중립화)
...
**가이드:**
- 판사 auto (Cycle 7 정책 적용 — 평가성 의도 어휘 회피): "어머니 말년 시기에 녹음된 담당자 음성 자료가 추가로 확보됐습니다. 본 법정에 [전 요양보호사 음성증언]을 증거 자료로 등록합니다." (이전 "보강하기 위해 / 필요한 시점이라 봅니다" → 사실 진술로 중립화)
- B respond: "예, 받아들이겠습니다."
