...
본 폴더에 복사돼 있음 — Batch 1과 동일 목록 + `feedback_judge_dispassionate_action_focused.md` (재판관 어법 사실/행위 중심, Cycle 7 신규). 정독 후 작성.

**Cycle 7 신규 정책 핵심:**
- 재판관 발화에 감정·가치 어휘 X
- 사실·행위·선후관계 중심 어휘 사용
- 평가성 결정 어휘 ("충분히 정리됐다고 봅니다", "필요한 시점이라 봅니다") 회피
- **증인 호출 동사 다양화** — w-2 호출 entry에서 "부르겠습니다" / "모시겠습니다" / "직접 들어보겠습니다" / "확인해 보겠습니다" 등 다양화 권장 (단일 반복 회피)
...
**가이드:**
- 판사 auto (Cycle 7 정책 적용 — 평가성 어휘 회피): "공증 절차 영역의 관련 자료가 모였습니다. 본 법정에 단서 [수정된 유언장]을 등록합니다." (이전 "충분히 정리됐다고 봅니다" → 사실 진술로 중립화)
- B respond: "예, 받아들이겠습니다."
...
**가이드:**
- 판사 auto (Cycle 7 정책 적용 — 호출 동사 다양화 + 평가성 어휘 회피): "공증 절차 영역의 메모 담당자 관련 진술이 필요합니다. 김영수 씨를 본 법정에 모시도록 준비하겠습니다." (이전 "필요한 시점이라 봅니다 / 부르도록 준비" → 호출 동사 다양화. T1=cascade는 "모시겠습니다", T2=interject은 "직접 말씀을 듣겠습니다 + 모시도록", T3=fallback은 다른 동사 사용 권장)
- B respond: "예, 받아들이겠습니다."
