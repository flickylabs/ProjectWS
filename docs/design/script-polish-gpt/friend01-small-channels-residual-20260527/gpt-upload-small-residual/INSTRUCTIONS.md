# GPT Pro 작업 지시서 — friend-01 small channel 어색 잔존 통합 (58 entries)
...
- 채널 구성 (10개):
  ...
  - witness (2): NPC/증인 발화 (formal)
  - aftermath (7): NPC 자백 후 후일담 (감정 표출, late 단계)
  - mediation (8): NPC 화해/타협 발화
  - contradiction_pursuit (4): NPC가 상대 모순 지적·추궁
  - interjection (3): NPC 끼어듦 (격앙/거부/방어)
  - emotional_overload (6): NPC 감정 격앙·폭발 영역
  - evidence_discovery (1): 증거 발견 메타 발화
  - trust_action (7): 신뢰 행동 발화 (감정·관계 톤)
...
- friend-01 (친구·예비신랑·연락 기록·돈 흐름) 진실 누설 정책 부합
...
상단에 `## friend-01 small channel 어색 잔존 통합 (58 entries) 결과` 헤더.
...
8. **진실 누설 자가 점검** (policy-02): friend-01 진실 누설 정책: 5 keyword × dispute 5 chain disclosure tier.
...
파일명: `friend01-small-channels-residual-result.md`
파일 내용은 위 "출력 형식" 그대로.
