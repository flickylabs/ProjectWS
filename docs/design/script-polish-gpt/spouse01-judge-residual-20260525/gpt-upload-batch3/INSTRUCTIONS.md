# GPT Pro 작업 지시서 — spouse-01 Batch 3 (dc-4.a.q2) polish
...
- **`batch-03-dc4-a-q2.md`** — Batch 3 (15 entries, 자연화 위주, 박지연 송금 영역)
...
- 모호한 곳에 임의 명사구 추가 X
- ★ "수치심" / "피해자 위치" 명사는 frame 의도 — 보존 (사용자 시안 의도)
...
- 본 Batch 3은 박지연 송금 영역 (시댁 link 없음). 원본 위반 entry 없으나 hidden 정책 동일 적용
