# GPT Pro 작업 지시서 — friend-01 interrogation 어색 잔존 통합 (125 entries)
...
**★ 본 batch 특이성**:
- 강조 부사 "그렇게" dominant 단일 batch. 125 entries 1:1 polish.
- **interrogation channel** = 재판관/상대방이 NPC에게 심문하면 NPC가 답하는 자기 진술 영역
- friend-01 사건 — 친구 사건 진실 누설 정책 부합 필수
...
상단에 `## friend-01 interrogation 어색 잔존 통합 (125 entries) 결과` 헤더.
...
4. **그렇게 96 + 끝까지 9 + 그_부분 5 + 잔존** 영역 자연화 패턴:
   - "그렇게" 직역체 → 명확 표현 또는 제거
...
6. **진실 누설 정책** (policy-02 정독 필수):
   - friend-01 사건 hidden keyword 신규 도입 절대 X
