# GPT Pro 작업 지시서 — family-01 interrogation Batch B — "끝까지" 강조 부사 (57 entries)
...
**★ 본 batch 특이성**:
- 강조 부사 "끝까지" 단일 패턴 batch. 57 entries 1:1 polish.
- **interrogation channel** = 재판관/상대방이 NPC에게 심문하면 NPC가 답하는 자기 진술 영역
- family-01 사건 — 가족 사건 진실 누설 정책 부합 필수
...
- **`batch-interrogation-B-kkeutkkaji.md`** — 변경 대상 entries 표
...
상단에 `## family-01 interrogation Batch B — "끝까지" 강조 부사 (57 entries) 결과` 헤더.
...
4. **강조부사:끝까지** 영역 자연화 패턴:
   - "끝까지" 추궁 영역 자연 보존 / 직역체 영역 자연화
   - "끝까지 ~지 못했습니다" / "끝까지 ~지 않았습니다" 등 자연 표현 보존
...
6. **진실 누설 정책** (policy-02 정독 필수):
   - family-01 사건 hidden keyword 신규 도입 절대 X
