# GPT Pro 작업 지시서 — family-01 interrogation Batch C — 잔존 패턴 묶음 (63 entries)
...
**★ 본 batch 특이성**:
- 완전히 / 그_부분 / 그_판단 / 차분히 / 진짜 / 느껴집니다 잔존 batch. 63 entries 1:1 polish.
...
- **`batch-interrogation-C-rest.md`** — 변경 대상 entries 표
...
상단에 `## family-01 interrogation Batch C — 잔존 패턴 묶음 (63 entries) 결과` 헤더.
...
4. **잔존 다중 패턴** 영역 자연화 패턴:
   - 다중 패턴: 강조부사 완화 + 추상명사 구체화 + 직역체 자연화 + 피동 회피
