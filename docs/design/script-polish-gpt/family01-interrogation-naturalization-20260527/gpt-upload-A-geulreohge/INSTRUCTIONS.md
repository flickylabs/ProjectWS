# GPT Pro 작업 지시서 — family-01 interrogation Batch A — "그렇게" 강조 부사 (109 entries)
...
- **`batch-interrogation-A-geulreohge.md`** — 변경 대상 entries 표
...
상단에 `## family-01 interrogation Batch A — "그렇게" 강조 부사 (109 entries) 결과` 헤더.
