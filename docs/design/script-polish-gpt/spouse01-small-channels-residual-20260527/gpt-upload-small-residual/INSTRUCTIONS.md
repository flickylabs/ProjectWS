# GPT Pro 작업 지시서 — spouse-01 small channel 어색 잔존 통합 (77 entries)
...
- 채널 구성 (11개):
  - interrogation (14): NPC 자기 진술 (재판관 추궁에 답변, lieState 단계 톤 보존)
  - dossier (13): NPC 1:1 답변 (toJudge formal honorific, 재판관님 호명)
  - witness (5): NPC/증인 발화 (formal)
  - aftermath (4): NPC 자백 후 후일담 (감정 표출, late 단계)
  - contradiction_pursuit (12): NPC가 상대 모순 지적·추궁
  - emotional_overload (5): NPC 감정 격앙·폭발 영역
  - evidence_discovery (1): 증거 발견 메타 발화
  - trust_action (11): 신뢰 행동 발화 (감정·관계 톤)
  - mediation (6): NPC 화해/타협 발화
  - rapport_milestone (5): 관계 진전 milestone
  - contradict_milestone (1): 모순 발견 milestone
- 자기지시 정책 ([[feedback_self_reference_speaker_context]]):
  - **NPC 1인칭 자기 발화 영역**: "본인 / 자신" 사용 X → "저 / 제" 자연화 (정리 대상)
  - 본 batch entries 자기지시 영역 = 모두 정리 대상
- 패턴 분포: 추상명사:그_점: 19 + 강조부사:그렇게: 13 + 강조부사:끝까지: 12 + 자기지시:자신: 10 + 강조부사:완전히: 5 + 강조부사:철저히: 3 + 추상명사:그_부분: 3 + 추상명사:그_판단: 2 + 자기지시:본인: 2 + 추상명사:그_상황: 2 + 피동:느껴집니다: 2 + 강조부사:차분히: 2 + 직역어미:드러납니다: 1 + 추상명사:그_결론: 1 + 직역어미:이어집니다: 1
- 77 unique entries 1:1 polish
...
상단에 `## spouse-01 small channel 어색 잔존 통합 (77 entries) 결과` 헤더.
...
파일명: `spouse01-small-channels-residual-result.md`
파일 내용은 위 "출력 형식" 그대로.
