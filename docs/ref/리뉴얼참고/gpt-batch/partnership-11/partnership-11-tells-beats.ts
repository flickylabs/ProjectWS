export const partnership11TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "partial",
      "line": "제가 먼저 계약서와 보증금을 움직인 건 맞습니다. 다만 그때는 놓치면 끝이라고 봐서 우선 확보라고 판단했습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "제가 지점 계약을 독단으로 한 사실과 별개로, 아린 씨도 법인과 거래처 분리를 준비했습니다. 다만 한쪽만 피해자인 구조는 아니었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "partial",
      "line": "분리 운영 메모를 짜면서도 독점공급과 상표 범위를 가볍게 본 건 맞습니다. 다만 실행 제약을 충분히 검토하지 못했습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "deny",
      "line": "그 전에 말씀드리면, 별도 법인은 혹시 모를 상황에 대비한 껍데기였어요. 거래처 전환을 확정한 적은 없습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "hedge",
      "line": "팝업 때부터 제가 해온 건 다 아실 텐데, 등기와 DM, 메일이 있었던 건 맞지만 세무 구조를 알아보는 수준이었어요. 그걸 바로 거래처 탈취 준비라고 보긴 어렵죠.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "blame",
      "line": "제가 해온 건 브랜드를 키운 거잖아요, 그런데 밀려나는 징후가 너무 많았어요. 그래서 핵심 거래처를 지켜보려면 따로 구조를 준비할 수밖에 없다고 느꼈습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "evidence_hit",
      "line": "등기부랑 원본 메일까지 같이 나오면 더는 '아이디어'라고만 할 수 없네요. 그게 다 말해주잖아요, 준비가 실제 수준이었다는 건 인정할게요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "deny",
      "line": "그 계약 한 장이 나오기 전까지 저는 재원 씨의 일방적 확장 침해를 당한 피해자였어요. 그때 저는 브랜드를 지키려던 사람일 뿐이었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "hedge",
      "line": "별도 구조를 생각한 적은 있어도 그건 피해를 막기 위한 상상 수준이었어요. 그날 이후로 순수 피해자라는 그림이 크게 틀리진 않습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "blame",
      "line": "순수 피해자만은 아니었습니다. 누가 먼저 몰았는지 보세요, 저도 상대를 믿지 못해 먼저 출구를 만들었고, 그 불신은 재원 씨가 먼저 만든 거라고 느꼈어요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "그 계약 한 장이 제 준비 시점과 같이 놓이면, 제가 순수 피해자라고만 말할 수는 없겠네요. 그 부분은 접겠습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "그 전에 공동 기회 조항을 깬 건 재원 씨 쪽이에요. 저는 밀려나는 상황에서 방어만 한 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "합의상 별도 법인도 공동 기회라는 건 알고 있었어요. 그런데 제가 왜 그랬겠어요, 그 무렵엔 제가 배제된다고 느껴 공개를 미뤘습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "그렇게까지 대비해야 했던 이유를 보세요, 재원 씨가 먼저 지점 lease를 움직였기 때문에 저도 거래처 방어선을 따로 쌓았어요. 적어도 저 혼자 그 조항을 무너뜨린 건 아니에요.",
