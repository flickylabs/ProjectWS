export const partnership08TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "deny",
      "line": "따로 스튜디오를 차리려던 게 아니에요. 5년 동안 쌓은 게 무너질 때 대비할 살 길을 찾은 거예요.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "hedge",
      "line": "그 DM 한 장으로 독립 준비라고 단정하는 건 너무 빠르죠. 그 한마디 맥락이 다 잘렸잖아요.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "blame",
      "line": "그날 이후 시원 씨가 언제든 끊을 수 있다는 불안이 컸어요. 그래서 제가 먼저 도망칠 구멍을 판 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "confession",
      "line": "네, 저는 별도 스튜디오 준비를 실제로 했습니다. 브랜드를 지키겠다는 이유로 말했지만 회사 밖 판까지 짜고 있었어요. 그건 제 잘못이에요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "deny",
      "line": "저는 그 한마디에 일방적으로 약속을 깨진 사람입니다. 배신, 그게 이 일의 시작이에요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "hedge",
      "line": "뭘 준비했다 해도 그건 먼저 끊긴 뒤에 살 길을 버티려고 본 길이었어요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "시원 씨가 마지막에 보류한 건 분명하고, 그날 이후 제가 무너진 것도 맞아요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "별도 법인 초안까지 나오면 제가 순수한 피해자라고만 버틸 수는 없어요. 회원 증가와 브랜드를 지키겠다 했지만 저도 이미 다른 출구를 준비했다는 뜻이니까요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "부속합의는 시원 씨가 먼저 깬 거예요. 5년 동안 쌓은 관계를 저는 그 뒤에 밀려나서 흔들린 거고요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "서면 조건이 남아 있었던 건 맞고, 다만 저도 그 틀 안에서 완전히 안전하게 움직인 건 아니었어요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "그래도 저는 밀려난 쪽이었습니다. 제가 왜 따로 준비했겠어요, 그 압박에서 나온 반응이었어요.",
