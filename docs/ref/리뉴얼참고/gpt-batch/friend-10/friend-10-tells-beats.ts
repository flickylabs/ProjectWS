export const friend10TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "공유 웨딩 체크리스트 revision history하고 유상우 반주자 DM까지 겹치면 제가 버틸 말이 없어요. 들러리는 진행중, 축가는 후보였는데 제가 둘을 같은 칸처럼 읽은 거예요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "그 규칙 모르는 사람 아니에요. 이번 건 공식 공지라기보다 내부 정리였다고 생각했어요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "이전 결혼식 뒤 확정 규칙 대화가 나오면 핑계가 안 되네요. 그 규칙을 정확히 알고도 제가 이번엔 제 편의대로 무시했어요.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "evidence_hit",
      "line": "드레스 치수표, 입장 동선 확인표까지 보면 숨을 데가 없네요. 들러리는 꽤 진행했고, 축가는 못 할 수도 있다는 말을 제가 너무 늦게 했어요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "이전 결혼식 뒤 확정 규칙 대화를 보면 더 말 못 하겠네요. 저도 그 약속을 분명히 기억했고, 그래서 더 빨리 끊었어야 했어요.",
