export const friend06TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "blame",
      "line": "다만 다솔이 공동 스레드만 지켰다면 제가 업계 단톡까지 끌고 갈 일도 줄었을 거예요. 그리고 회수는 문제 게시물 하나가 아니라 블로그와 채널 전체에 걸렸어요.",
    ...
    },
    {
      ...
      "line": "로그가 저렇게 맞물리면 더는 기술적으로 돌릴 수는 없네요. 공개 비난부터 하고 채널 전체 접근권을 끊은 건 제 잘못이에요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "로그가 저렇게 맞물리면 더는 기술적으로 돌릴 수는 없네요. 무단 침입이라고 단정한 제 말은 틀렸어요.",
      "behaviorHint": "스크린을 보다가 잠깐 멈추고 말수와 속도가 눈에 띄게 줄어든다.",
      "applicableStates": [
        "S1",
        "S2"
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "evidence_hit",
      "line": "로그가 저렇게 맞물리면 더는 기술적으로 돌릴 수는 없네요. 공동 확인 원칙을 저도 깼어요.",
      "behaviorHint": "스크린을 보다가 잠깐 멈추고 말수와 속도가 눈에 띄게 줄어든다.",
      "applicableStates": [
        "S1",
        "S2",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "blame",
      "line": "다만 해온이 바로 답을 줬다면 나는 거기까지 안 갔을 거다. 그래서 그때는 핀댓글 삭제까지 같은 세션에서 일어난 건 내 쪽 작업 책임으로 봐야 한다도 크게 안 보였어요.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "evidence_hit",
      "line": "원문과 로그가 같이 나오면 저도 더는 '살리려던 거였다'만 반복하긴 어렵죠. 직접 수정하고 핀댓글까지 없앤 건 내 판단 미스다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "원문과 로그가 같이 나오면 저도 더는 '살리려던 거였다'만 반복하긴 어렵죠. 브랜드 요청 범위를 넘겨 편집한 건 맞다.",
      "behaviorHint": "로그가 제시되면 웃음기가 사라지고 말끝이 짧아지다가 갑자기 느려진다.",
      "applicableStates": [
        "S1",
        "S2"
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "다만 해온도 그다음 단톡 공개와 전체 차단으로 같은 원칙을 무너뜨렸다. 그래서 그때는 규칙을 지키려 했다면 최소한 공동 스레드에 요청 원문부터 남겼어야 했다도 크게 안 보였어요.",
      "behaviorHint": "자신이 수습하던 목록을 늘어놓다가 상대 침묵을 끼워 넣어 되받아친다.",
      "applicableStates": [
        "S3"
      ],
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "evidence_hit",
      "line": "원문과 로그가 같이 나오면 저도 더는 '살리려던 거였다'만 반복하긴 어렵죠. 급했다는 이유로 공동 확인 규칙을 건너뛴 건 내 잘못이다.",
      "behaviorHint": "로그가 제시되면 웃음기가 사라지고 말끝이 짧아지다가 갑자기 느려진다.",
      "applicableStates": [
        "S1",
        "S2",
