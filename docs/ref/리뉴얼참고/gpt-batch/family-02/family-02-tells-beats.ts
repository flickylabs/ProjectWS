export const family02TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "line": "접속 시각이랑 단톡 시간이 그렇게 붙어 있으면 부인만 할 수는 없죠. 다만 그 화면 하나로 집안이 무너지는 것 같아서 내가 먼저 반응한 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "confession",
      "line": "직접 외부에 닿은 손이 민지 쪽이었다는 건 인정합니다. 다만 그 재료를 넘겨준 출발점이 저였고, 그걸 숨긴 건 두려움 때문이었습니다.",
