export const family11TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "성인용 시럽을 산 것도 사실입니다. 아이가 너무 뜨거우니 뭐라도 해야 할 것 같아 제멋대로 판단해 버렸어요. 하지만 하린이 쪽도 야근 주간에 엄마 돌봄에 기대면서 루틴을 직접 챙기지 않았잖아요.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "센터 동의서를 다시 보니 저도 절차를 지키지 않았습니다. 엄마를 막는 방식이 곧 규칙 준수라고 착각한 거죠. 그래도 엄마 쪽이 먼저 신청서에 허락 없이 이름을 넣고 약까지 임의로 준 부분은 봐야 하잖아요.",
