export const spouse10TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "partial",
      "line": "어머니께 먼저 말씀드리고 선물 예약까지 한 건 맞습니다. 그땐 수아도 비슷하게 아는 줄 알았어요.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "blame",
      "line": "수아가 '본가', '가까운 쪽 먼저'라고만 하니까 저는 우리 집 점심 먼저로 굳었어요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "blame",
      "line": "수아가 애매하게 말하니까 저는 제 식으로 정리해 버렸어요. 그 착각이 문제였죠.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "수아 표현이 애매했던 데다 저도 이동시간을 쉽게 봤습니다. 둘이 겹쳐서 꼬였어요.",
