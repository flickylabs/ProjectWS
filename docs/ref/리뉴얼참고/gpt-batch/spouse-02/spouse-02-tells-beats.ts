export const spouse02TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "저는 과거를 공식 문제로 올린 적 없습니다. 먼저 그 선을 넘은 건 도윤 씨입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "도윤 씨가 상담기록을 꺼내지만 않았어도 저도 거기까지는 안 갔습니다. 방어였다고 해도 잘한 일은 아닙니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "행정 오류가 직접 원인이어도 우리 싸움이 학교를 더 경직되게 만든 건 사실입니다. 그래서 저는 더 빨리 최악으로 해석했습니다. 하지만 도윤 씨 쪽도 상담기록을 먼저 꺼내 분위기를 몰아간 책임이 있잖아요.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "confession",
      "line": "직접 원인은 주소 오류였습니다. 저는 그걸 확인도 없이 도윤 씨 탓으로 묶었습니다.",
