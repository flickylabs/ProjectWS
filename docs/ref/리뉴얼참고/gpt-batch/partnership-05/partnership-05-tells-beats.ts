export const partnership05TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "line": "e-1까지 나오면 부인할 건 없네요. 토큰 없이 제가 실행한 흔적이 남아 있으니, 이제는 왜 그랬는지를 말해야겠습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "회의 메모대로 우리 둘 다 완화 문구에 동의했습니다. 다만 실제 목적을 축소한 설명이었다는 점도 인정합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "저도 완화 문구를 확인하고 통과시켰어요. 다만 실제 목적을 축소한 설명이었다는 점은 인정해요.",
