export const partnership02V3GameLoopData = {
      ...
      "challenges": [
        {
          ...
          "questions": [
            {
              "id": "dossier-1.a.q1",
              "text": "박준오 씨, CRM 로그상 최초 리드와 초안은 당신이 맞습니다. 그런데 그 사실만으로 지금도 스스로를 '순수한 피해자'라고 단정하십니까?",
              "attackVector": "context",
              "onSuccess": {
                "blockVector": "context",
                "revealAtom": "partnership-02:a:d-3:unlock:s2:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                ...
                "revealAtom": "partnership-02:a:d-3:unlock:s3:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                ...
                "revealAtom": "partnership-02:a:d-3:unlock:s4:0",
                "lieAdvance": true
              }
            }
          ]
        },
        {
          ...
          "questions": [
            {
              "id": "dossier-1.b.q1",
              "text": "서민경 씨, 최종 부속문서와 승인안에 당신만 주공로자로 남은 건 사실입니다. 이걸 아직도 단순 제출 책임 정리라고 보십니까?",
              "attackVector": "authenticity",
              "onSuccess": {
                "blockVector": "authenticity",
                "revealAtom": "partnership-02:b:d-2:unlock:s2:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "context",
                "revealAtom": "partnership-02:b:d-2:unlock:s3:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                ...
                "revealAtom": "partnership-02:b:d-2:unlock:s4:0",
                "lieAdvance": true
              }
            }
          ]
      ...
      "challenges": [
        {
          ...
          "questions": [
            {
              "id": "dossier-2.a.q1",
              "text": "박준오 씨, 캡처본이 아니라 원본 메일과 첨부까지 나왔습니다. 시훈데이터랩 명의 파일럿 가능성을 실제로 물으신 거죠?",
              "attackVector": "authenticity",
              "onSuccess": {
                "blockVector": "authenticity",
                "revealAtom": "partnership-02:a:d-1:unlock:s2:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "legality",
                "revealAtom": "partnership-02:a:d-1:unlock:s3:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "legality",
                "revealAtom": "partnership-02:a:d-1:unlock:s5:0",
                "lieAdvance": true
              }
            }
          ]
        },
        {
          ...
          "questions": [
            {
              "id": "dossier-2.b.q1",
              "text": "서민경 씨, 단일 창구 요청은 고객사 선요청이었습니까, 아니면 당신의 내부 정리 이후였습니까?",
              "attackVector": "authenticity",
              "onSuccess": {
                "blockVector": "authenticity",
                "revealAtom": "partnership-02:b:d-5:unlock:s2:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "context",
                "revealAtom": "partnership-02:b:d-5:unlock:s3:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "legality",
                "revealAtom": "partnership-02:b:d-5:unlock:s4:0",
                "lieAdvance": true
              }
            }
          ]
      ...
      "challenges": [
        {
          ...
          "questions": [
            {
              "id": "dossier-3.a.q1",
              "text": "박준오 씨, 서명된 RACI 6대4 구조를 알고 있었으면서도 외부 라인을 우회한 점은 인정하십니까?",
              "attackVector": "legality",
              "onSuccess": {
                "blockVector": "legality",
                "revealAtom": "partnership-02:a:d-4:unlock:s2:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "context",
                "revealAtom": "partnership-02:a:d-4:unlock:s4:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "authenticity",
                "revealAtom": "partnership-02:a:d-4:unlock:s5:0",
                "lieAdvance": true
              }
            }
          ]
        },
        {
          ...
          "questions": [
            {
              "id": "dossier-3.b.q1",
              "text": "서민경 씨, 고객사 검토 메모상 단일 창구의 직접 계기는 준오의 별도 제안과 첨부였습니다. 그 사실을 이제는 분명히 말씀하시겠습니까?",
              "attackVector": "authenticity",
              "onSuccess": {
                "blockVector": "authenticity",
                "revealAtom": "partnership-02:b:d-5:unlock:s5:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "legality",
                "revealAtom": "partnership-02:b:d-4:unlock:s5:0",
                "lieAdvance": true
              }
            },
            {
              ...
              "onSuccess": {
                "blockVector": "context",
                "revealAtom": "partnership-02:b:d-2:unlock:s5:0",
                "lieAdvance": true
              }
            }
          ]
  ...
  "stateUnlockAtoms": {
    "a": {
      "d-1": {
        "S2": [
          {
            "id": "partnership-02:a:d-1:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:a:d-1:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:a:d-1:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:a:d-1:unlock:s5:0",
      ...
      "d-3": {
        "S2": [
          {
            "id": "partnership-02:a:d-3:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:a:d-3:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:a:d-3:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:a:d-3:unlock:s5:0",
      ...
      "d-4": {
        "S2": [
          {
            "id": "partnership-02:a:d-4:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:a:d-4:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:a:d-4:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:a:d-4:unlock:s5:0",
    ...
    "b": {
      "d-2": {
        "S2": [
          {
            "id": "partnership-02:b:d-2:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:b:d-2:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:b:d-2:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:b:d-2:unlock:s5:0",
      ...
      "d-5": {
        "S2": [
          {
            "id": "partnership-02:b:d-5:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:b:d-5:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:b:d-5:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:b:d-5:unlock:s5:0",
      ...
      "d-4": {
        "S2": [
          {
            "id": "partnership-02:b:d-4:unlock:s2:0",
        ...
        "S3": [
          {
            "id": "partnership-02:b:d-4:unlock:s3:0",
        ...
        "S4": [
          {
            "id": "partnership-02:b:d-4:unlock:s4:0",
        ...
        "S5": [
          {
            "id": "partnership-02:b:d-4:unlock:s5:0",
  ...
  "events": {
    "contradictions": [
      {
        "id": "partnership-02:contradiction:0",
        "targetParty": "a",
      ...
      {
        "id": "partnership-02:contradiction:1",
        "targetParty": "b",
      ...
      {
        "id": "partnership-02:contradiction:2",
        "targetParty": "b",
      ...
      {
        "id": "partnership-02:contradiction:3",
        "targetParty": "a",
    ...
    "interjections": [
      {
        "id": "partnership-02:interjection:0",
        "speaker": "a",
      ...
      {
        "id": "partnership-02:interjection:1",
        "speaker": "b",
      ...
      {
        "id": "partnership-02:interjection:2",
        "speaker": "judge",
    ...
    "emotionalOutbursts": [
      {
        "id": "partnership-02:outburst:a:0",
        "party": "a",
      ...
      {
        "id": "partnership-02:outburst:a:1",
        "party": "a",
      ...
      {
        "id": "partnership-02:outburst:b:0",
        "party": "b",
      ...
      {
        "id": "partnership-02:outburst:b:1",
        "party": "b",
  ...
  "transitionBeats": [
    {
      "id": "partnership-02:transition:a:d-1:s0_s1",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-1",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:a:d-1:s1_s2",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-1",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:a:d-1:s2_s3",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-1",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:a:d-1:s3_s5",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-1",
      "fromState": "S3",
    ...
    {
      "id": "partnership-02:transition:a:d-3:s0_s1",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-3",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:a:d-3:s1_s2",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-3",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:a:d-3:s2_s4",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-3",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:a:d-3:s4_s5",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-3",
      "fromState": "S4",
    ...
    {
      "id": "partnership-02:transition:a:d-4:s0_s1",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-4",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:a:d-4:s1_s2",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-4",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:a:d-4:s2_s5",
      "caseId": "partnership-02",
      "party": "a",
      "disputeId": "d-4",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:b:d-2:s0_s1",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-2",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:b:d-2:s1_s2",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-2",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:b:d-2:s2_s3",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-2",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:b:d-2:s3_s5",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-2",
      "fromState": "S3",
    ...
    {
      "id": "partnership-02:transition:b:d-5:s0_s1",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-5",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:b:d-5:s1_s2",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-5",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:b:d-5:s2_s4",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-5",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:b:d-5:s4_s5",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-5",
      "fromState": "S4",
    ...
    {
      "id": "partnership-02:transition:b:d-4:s0_s1",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-4",
      "fromState": "S0",
    ...
    {
      "id": "partnership-02:transition:b:d-4:s1_s2",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-4",
      "fromState": "S1",
    ...
    {
      "id": "partnership-02:transition:b:d-4:s2_s3",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-4",
      "fromState": "S2",
    ...
    {
      "id": "partnership-02:transition:b:d-4:s3_s5",
      "caseId": "partnership-02",
      "party": "b",
      "disputeId": "d-4",
      "fromState": "S3",
