export const partnership01TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "partial",
      "line": "네, 320만원 비환급 위험은 있었습니다. 제가 그 조항을 충분히 짚어 설명하지 않은 것도 맞습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "deny",
      "line": "회식 자리에서 가능성 얘기한 걸 왜 최종 승인으로 바꿉니까. 저는 '보내라'고 말한 적 없습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "hedge",
      "line": "2,000만원 한도 얘길 했더라도 그건 투자 성사 전제를 놓고 해본 말입니다. 정식 승인 절차를 대신할 수는 없어요.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "네, 먼저 예치 가자고 한 취지의 말은 했습니다. 그래도 그걸 바로 송금하라는 최종 오케이로 보는 건 제 의도와 다릅니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "blame",
      "line": "서준 씨는 정식 승인도 안 받아놓고 제 회식 발언 하나를 면책증거처럼 들고 나왔습니다. 모호한 구두 대화를 자기 절차 위반의 방패로 쓰면 안 되죠.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "원본 단톡과 음성메모가 동시에 나오면 '그런 말 한 적 없다'는 선은 바로 무너집니다. 남는 건 그 말을 왜 나중에 없던 일로 만들었느냐죠.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "세무사에게 허위 분개를 지시한 적 없습니다. 서준 씨가 자기 송금을 덮으려고 회계 명목을 끌어다 쓴 거예요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "hedge",
      "line": "직원 불안을 막자고 표현을 순하게 하자는 말과 공식 분개 지시는 다른 문제입니다. 위기관리 멘트를 회계 명령으로 키워 읽지 마세요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "제 위기관리용 말을 서준 씨는 자기 방패처럼 써버렸습니다. 제가 던진 임시 표현을 회계 처리 면허로 받아쓴 다음 책임만 다시 제 쪽에 밀고 있잖아요.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "세무사 원본 메일이 나오면 말은 끝나요. 누가 먼저 그 명목을 제안했는지가 문장 그대로 남으니까요.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "deny",
      "line": "그 캡처를 보면 누구라도 같은 의심을 합니다. 개인 채무부터 막은 거 아니냐는 해석이 왜 그렇게 이상하죠?",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "hedge",
      "line": "원본이 없어서 단정은 못 해도 그 한 줄이 수상하다는 인상까지 지워지진 않습니다. 설명을 안 한 사람이 먼저 책임져야죠.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "blame",
      "line": "제가 그 프레임을 세게 민 건 사실이지만 애초에 가장 나쁜 상상을 하게 만든 쪽도 서준 씨입니다. 원본도 없이 캡처만 남게 해놓고 왜 의심은 제 몫만 되나요.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "evidence_hit",
      "line": "투자자 확인 메일이 붙는 순간 '개인 빚'이라는 말은 버려야 합니다. 그때 남는 건 제가 왜 약한 캡처를 강한 비난으로 키웠느냐는 문제뿐입니다.",
