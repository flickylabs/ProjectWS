export const partnership04TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "partial",
      "line": "일부 정산을 투명하게 못 드러낸 건 제 잘못입니다. 그 부분은 숨겼다고 보셔도 됩니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "표기 방식이 헷갈리게 만든 건 맞습니다. 제가 그 설명을 바로 못 한 것도 맞고요.",
      "behaviorHint": "짧게 숨을 고르고 일부 단어를 또박또박 분리한다.",
      "applicableStates": [
        "S2"
      ],
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "저도 그 과거를 완전히 떼어놓진 못했습니다. 제게 불리한 대목은 작게 말했죠.",
      "behaviorHint": "짧게 숨을 고르고 일부 단어를 또박또박 분리한다.",
      "applicableStates": [
        "S2"
      ],
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "제가 그 세 줄을 너무 빨리 하나의 서사로 묶은 건 맞아요. 다만 캡처와 과거 기억이 겹치면서 그렇게 읽힌 사정은 있었어요.",
      "behaviorHint": "시선을 흔들며 일부 인정 뒤에 피해 서사를 덧붙인다.",
      "applicableStates": [
        "S2"
      ],
...
export default partnership04TellsBeats;
