export const neighbor02TellsBeats = {
  ...
  "executableTells": {
    "a": [
      {
        "id": "neighbor02:a:tell:sympathy_stack",
        "appliesWhen": [
          "emotional",
          "hurt",
          "defensive",
      ...
      {
        "id": "neighbor02:a:tell:selective_victimhood",
        "appliesWhen": [
          "lying",
          "cornered",
          "shame",
      ...
      {
        "id": "neighbor02:a:tell:accusation_echo",
        "appliesWhen": [
          "cornered",
          "defensive",
          "hurt",
    ...
    "b": [
      {
        "id": "neighbor02:b:tell:clause_recital",
        "appliesWhen": [
          "lying",
          "avoiding",
          "defensive",
      ...
      {
        "id": "neighbor02:b:tell:timestamp_wall",
        "appliesWhen": [
          "cornered",
          "lying",
          "defensive"
      ...
      {
        "id": "neighbor02:b:tell:affect_flattening",
        "appliesWhen": [
          "avoiding",
          "hurt",
          "emotional",
  ...
  "beatScripts": [
    ...
    {
      "id": "neighbor02:beat:a:d-1:hedge",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-1",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:a:d-1:partial",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-1",
      "beatType": "partial",
    ...
    {
      "id": "neighbor02:beat:a:d-1:blame",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-1",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:a:d-1:confession",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-1",
      "beatType": "confession",
      "line": "네, 제가 캡처 한 장으로 민규 씨를 수상한 사람처럼 보이게 했어요. 확인보다 제 불안과 인상을 먼저 믿었습니다.",
    ...
    {
      "id": "neighbor02:beat:a:d-1:evidence_hit",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-1",
    ...
    {
      "id": "neighbor02:beat:a:d-4:hedge",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-4",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:a:d-4:partial",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "원본을 보니 박스를 열진 않았네요. 다만 그 전까진 저도 몰랐고, 그래서 걱정이 앞섰던 거예요.",
    ...
    {
      "id": "neighbor02:beat:a:d-4:blame",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-4",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:a:d-4:confession",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-4",
      "beatType": "confession",
    ...
    {
      "id": "neighbor02:beat:a:d-4:evidence_hit",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-4",
      "beatType": "evidence_hit",
    ...
    {
      "id": "neighbor02:beat:a:d-5:hedge",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-5",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:a:d-5:partial",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-5",
      "beatType": "partial",
    ...
    {
      "id": "neighbor02:beat:a:d-5:blame",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-5",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:a:d-5:confession",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-5",
      "beatType": "confession",
      "line": "제가 CCTV 캡처를 돌린 순간 이미 그 약속을 깼어요. 결국 저도 절차보다 '내가 당했다'는 말을 먼저 택했습니다.",
    ...
    {
      "id": "neighbor02:beat:a:d-5:evidence_hit",
      "caseId": "neighbor-02",
      "party": "a",
      "disputeId": "d-5",
      "beatType": "evidence_hit",
    ...
    {
      "id": "neighbor02:beat:b:d-2:hedge",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-2",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:b:d-2:partial",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-2",
      "beatType": "partial",
    ...
    {
      "id": "neighbor02:beat:b:d-2:blame",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-2",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:b:d-2:confession",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-2",
      "beatType": "confession",
    ...
    {
      "id": "neighbor02:beat:b:d-2:evidence_hit",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-2",
      "beatType": "evidence_hit",
    ...
    {
      "id": "neighbor02:beat:b:d-3:hedge",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-3",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:b:d-3:partial",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-3",
      "beatType": "partial",
    ...
    {
      "id": "neighbor02:beat:b:d-3:blame",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-3",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:b:d-3:confession",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-3",
      "beatType": "confession",
      "line": "익명 전단과 첫 단체방 문구의 실질적 출발점은 최병규였습니다. 저는 그걸 제 분노에 맞게 다시 퍼뜨렸습니다.",
    ...
    {
      "id": "neighbor02:beat:b:d-3:evidence_hit",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-3",
      "beatType": "evidence_hit",
    ...
    {
      "id": "neighbor02:beat:b:d-5:hedge",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-5",
      "beatType": "hedge",
    ...
    {
      "id": "neighbor02:beat:b:d-5:partial",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-5",
      "beatType": "partial",
    ...
    {
      "id": "neighbor02:beat:b:d-5:blame",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-5",
      "beatType": "blame",
    ...
    {
      "id": "neighbor02:beat:b:d-5:confession",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-5",
      "beatType": "confession",
      "line": "저도 관리사무소 확인 전 유나 씨를 특정하는 말을 퍼뜨려 약속을 깼습니다. 서로 절차보다 평판 싸움을 먼저 택했습니다.",
    ...
    {
      "id": "neighbor02:beat:b:d-5:evidence_hit",
      "caseId": "neighbor-02",
      "party": "b",
      "disputeId": "d-5",
      "beatType": "evidence_hit",
...
export default neighbor02TellsBeats;
