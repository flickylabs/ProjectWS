  ...
  "beatScripts": [
    {
      ...
      "disputeId": "d-1",
      "beatType": "deny",
      "line": "그건 징계가 아니라 잠정 차단이었습니다. 감사 직전에선 그런 조치가 먼저 갈 수 있습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "hedge",
      "line": "이름을 찍어 말한 적은 없습니다. 다만 당시엔 그쪽 접근을 묶어 두는 게 맞다고 본 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "partial",
      "line": "공식 번호 전 조정은 맞습니다. 하지만 그 순간엔 확산 차단이 절차보다 앞선다고 판단했습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "blame",
      "line": "민아 씨 쪽 정황이 한두 개가 아니었습니다. 심야 다운로드, 외부 연락, 개인 저장 흔적이 한꺼번에 겹쳤습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "confession",
      "line": "결국 제가 너무 빨리 한 사람을 범인처럼 봤습니다. 확인도 끝나기 전에 차단하고 분위기까지 몰은 건 제 잘못입니다.",
    ...
    },
    {
      ...
      "line": "52분 먼저 회수됐다는 기록이 나오면, 제가 절차를 앞질렀다는 말은 피하기 어렵습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "입막음을 한 게 아닙니다. 감사 중이니 정리 순서를 맞추자고 한 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "hedge",
      "line": "위험 메모도 분류 차원이었습니다. 그렇게까지 읽힐 줄은 몰랐습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "네, 메모는 먼저 들어갔습니다. 당시엔 제보와 유출 의심이 서로 엉켜 보였습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "blame",
      "line": "감사 직전에 비용 건까지 정식으로 올리면 라인이 무너질 수 있다고 봤습니다. 혼선 통제를 먼저 택한 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "confession",
      "line": "제가 먼저 위험 인물 프레임을 깔고, 비용 건은 뒤로 미루게 했습니다. 결과적으로 제보를 막은 건 제 책임입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "HR 원본 로그가 나오면 부인하기 어렵습니다. 면담 전에 제가 먼저 방향을 적어 넣었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "deny",
      "line": "저는 소문을 돌린 게 아니라 팀 불안을 관리한 겁니다. 이름을 찍어 말한 적도 없습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "hedge",
      "line": "공지 문구가 거칠었을 수는 있어도, 특정인을 겨냥한 건 아니었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "partial",
      "line": "제 말과 공지가 합쳐지면 민아 씨로 읽힐 수 있었다는 건 인정합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "하지만 단톡에서 희생양 얘기와 상사 비리설을 키운 건 민아 씨 쪽입니다. 소문전은 한쪽만의 일이 아니었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "confession",
      "line": "공식 조사 전에 저도 여론을 움직이려 했습니다. 상대를 먼저 고립시키면 정리가 쉬울 거라 본 건 제 잘못입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "evidence_hit",
      "line": "팀 공지와 접근권 회수 기록이 같이 나오면, 제가 불씨를 줄인 게 아니라 방향을 준 셈이 됩니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "deny",
      "line": "개인 드라이브에 원본을 빼낸 건 아닙니다. 외부 대화도 경력 상담 범위를 넘지 않았습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "hedge",
      "line": "정확히 말하면 보호용 메모와 초안 일부가 따로 저장된 겁니다. 기술적으로 원본 전체 유출과는 다릅니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "partial",
      "line": "네, 업로드는 있었습니다. 익명 유출 얘기가 돈 뒤였고, 저도 잘릴까 봐 흔적을 남긴 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "blame",
      "line": "외부 상담도 했습니다. 안전한 내부 채널이 없다고 느꼈고, 이미 제가 먼저 찍혀 있다고 봤습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "confession",
      "line": "무단 복사와 외부 상담, 둘 다 했습니다. 최초 원본 유출과는 다르지만 제 보호를 이유로 선을 넘은 건 제 잘못입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "evidence_hit",
      "line": "e-2가 뜨면 더는 저장 자체를 부정할 수 없습니다. 시점과 범위를 설명하는 쪽으로 물러설 수밖에 없습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "deny",
      "line": "제가 원본 유출자라는 말은 성립하지 않습니다. 그건 제 흔적을 너무 편한 답으로 붙인 겁니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "hedge",
      "line": "제 개인 드라이브 흔적과 원본 반출 시점은 맞지 않습니다. 적어도 타임라인은 저를 가리키지 않습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "회수되지 않은 링크가 있었다면 흐름은 달라집니다. 제가 만진 파일보다 먼저 열린 경로를 먼저 보셔야 합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "blame",
      "line": "저는 억울해서 규원 실장님 의도를 단정해 버렸습니다. 하지만 실제 문제는 링크와 토큰 관리가 허술했다는 데 있습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "confession",
      "line": "최초 원본 반출은 제가 아니었습니다. 다만 그 사실을 모르면서 규원 실장님 책임을 과장해 밀어붙인 건 인정합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "e-4만으로도 제 개인 드라이브보다 먼저 살아 있던 경로가 보입니다. 그 순간부터 저도 서사를 바꿔야 합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "deny",
      "line": "저는 소문을 퍼뜨린 게 아니라 방어적으로 반응한 겁니다. 이미 제 이름이 먼저 돌고 있었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "hedge",
      "line": "하소연은 했습니다. 하지만 그걸 소문전이라고 부르려면 먼저 불씨를 만든 쪽도 같이 봐야 합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "blame",
      "line": "감정이 올라오면서 상사 비리설 비슷한 말도 섞였습니다. 먼저 낙인찍힌 데 대한 반격이었지만 결과적으로는 저도 키웠습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "confession",
      "line": "공식 조사 전에 저도 여론전에 기대었습니다. 살아남으려는 마음으로 단톡과 주변 말을 이용한 건 제 잘못입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "evidence_hit",
      "line": "e-2와 단톡 맥락이 붙으면 '방어만 했다'는 말은 오래 못 갑니다. 제가 먼저 여론을 건드린 부분이 남습니다.",
