export const workplace02TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "partial",
      "line": "제 말과 공지가 합쳐지면 민아 씨로 읽힐 수 있었다는 건 인정합니다. 다만 당시엔 감사 일정 앞에서 팀이 더 불안정해지지 않게 하자는 취지였습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "evidence_hit",
      "line": "e-2가 뜨면 더는 저장 자체를 부정할 수 없습니다. 버전과 시각상 제가 말할 수 있는 건 동기와 범위뿐입니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "evidence_hit",
      "line": "e-4만으로도 제 개인 드라이브보다 먼저 살아 있던 경로가 보입니다. 로그상 그 순간부터 저도 서사를 바꿔야 합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-5",
      "beatType": "evidence_hit",
      "line": "e-2와 단톡 맥락이 붙으면 \"방어만 했다\"는 말은 오래 못 갑니다. 로그와 시각상 제가 먼저 여론을 건드린 부분이 남습니다.",
