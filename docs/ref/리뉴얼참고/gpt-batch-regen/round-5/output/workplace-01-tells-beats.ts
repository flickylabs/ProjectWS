export const workplace01TellsBeats = {
  ...
  "beatScripts": [
    ...
    },
    {
      ...
      "disputeId": "d-1",
      "beatType": "partial",
      "line": "박 대리가 프레임과 KPI 표를 만든 건 맞습니다. 다만 최종 문안, 보고 라인 정리, 임원 승인 책임까지 감안하면 팀 결과물로 봐야 합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "deny",
      "line": "제가 확보한 출력본에는 박 대리가 23시 48분 최종 수정자로 정리돼 있었습니다. 당시엔 그 자료 이상으로 해석할 이유가 없었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "partial",
      "line": "그 PDF가 완전한 감사 로그가 아니라는 점은 압니다. 다만 마감 직후엔 원본보다 그 출력본이 가장 빠른 설명이라고 판단했습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-3",
      "beatType": "blame",
      "line": "공용 PC와 관리자 토큰 개입이 있었다면 운영 관리도 같이 봐야 합니다. 서윤 씨 쪽도 새벽에 평가 화면을 열어 캡처를 뽑았고, 혼란스러운 심야 작업 책임을 전부 제 판단으로만 돌리긴 어렵습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "deny",
      "line": "평가 초안은 HR이 다루는 영역입니다. 제가 박 대리 점수에 비공식으로 손댔다고 보진 않습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "partial",
      "line": "점수 보정 직전에 메모를 넣은 건 맞습니다. 다만 그 문장이 어떻게 읽힐지는 HR과 평가 캘리브레이션 라인에서 정리될 문제라고 봤습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "confession",
      "line": "제가 점수 보정 직전에 비공개 메모를 넣어 방향에 영향을 줬습니다. 일반 피드백이라는 말로 정리하려 했지만, 실은 박 대리 평가선을 낮추려는 표현이었습니다.",
    ...
    },
    {
      ...
      "disputeId": "d-4",
      "beatType": "evidence_hit",
      "line": "버전기록에 제 계정 시각이 찍혀 있으면 부정할 수는 없습니다. 그 메모가 공식 결재선이 아닌 비공식 경로였다는 점도 인정합니다.",
    ...
    },
    {
      ...
      "disputeId": "d-2",
      "beatType": "partial",
      "line": "동료 두 명에게 보낸 건 맞아요. 그때는 새벽 1시대에 저 혼자 알고 있으면 바로 낙인찍힐 것 같았어요. 다만 캡처 보시듯, 퍼뜨리려던 것보다 확인을 구한 쪽에 가까웠어요.",
