# GPT Pro 세션 — 배치 04: friend-03 ~ friend-06 investigationStages 생성
...
| `friend-03-input.json` | case-friend-03 증거·쟁점 입력 |
| `friend-04-input.json` | case-friend-04 증거·쟁점 입력 |
| `friend-05-input.json` | case-friend-05 증거·쟁점 입력 |
| `friend-06-input.json` | case-friend-06 증거·쟁점 입력 |
...
첨부된 4건의 사건 JSON(friend-03, friend-04, friend-05, friend-06)을 읽고, 모든 증거에 대해 3단계 investigationStages를 생성해.
