# GPT Pro 세션 — 배치 08: neighbor-08 ~ neighbor-11 investigationStages 생성
...
| `neighbor-08-input.json` | neighbor-08 사건 데이터 |
| `neighbor-09-input.json` | neighbor-09 사건 데이터 |
| `neighbor-10-input.json` | neighbor-10 사건 데이터 |
| `neighbor-11-input.json` | neighbor-11 사건 데이터 |
...
첨부된 4건의 사건 JSON(neighbor-08, neighbor-09, neighbor-10, neighbor-11)을 읽고, 모든 증거에 대해 3단계 investigationStages를 생성해.
