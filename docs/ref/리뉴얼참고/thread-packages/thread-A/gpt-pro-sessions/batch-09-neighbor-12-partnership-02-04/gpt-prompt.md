# GPT Pro 세션 — 배치 09: neighbor-12 ~ partnership-04 investigationStages 생성
...
| `neighbor-12-input.json` | neighbor-12 사건 데이터 |
| `partnership-02-input.json` | partnership-02 사건 데이터 |
| `partnership-03-input.json` | partnership-03 사건 데이터 |
| `partnership-04-input.json` | partnership-04 사건 데이터 |
...
첨부된 4건의 사건 JSON(neighbor-12, partnership-02, partnership-03, partnership-04)을 읽고, 모든 증거에 대해 3단계 investigationStages를 생성해.
