# GPT Pro 세션 — 배치 16: tenant-07, tenant-08, tenant-09, tenant-10 investigationStages 생성
...
| `tenant-07-input.json` | tenant-07 사건 데이터 |
| `tenant-08-input.json` | tenant-08 사건 데이터 |
| `tenant-09-input.json` | tenant-09 사건 데이터 |
| `tenant-10-input.json` | tenant-10 사건 데이터 |
...
첨부된 4건의 사건 JSON(tenant-07, tenant-08, tenant-09, tenant-10)을 읽고, 모든 증거에 대해 3단계 investigationStages를 생성해.
