...
d.evidence[1].viewerData = {
  ...
  gps_log: [
    ...
    { timestamp: '02.18 19:14', lat: '37.4962', lng: '126.9461', speed: '0 km/h', location: '\u2605 봉천동 엔젤오피스텔 앞 (주차)', suspicious: true },
    ...
    { timestamp: '02.15 14:18', lat: '37.4962', lng: '126.9461', speed: '0 km/h', location: '\u2605 봉천동 엔젤오피스텔 앞 (주차)', suspicious: true },
    ...
    { timestamp: '02.12 18:22', lat: '37.4962', lng: '126.9461', speed: '0 km/h', location: '\u2605 봉천동 엔젤오피스텔 앞 (주차)', suspicious: true },
    { timestamp: '02.12 20:55', lat: '37.4962', lng: '126.9461', speed: '0 km/h', location: '(주차 유지 \u2014 2시간 32분)', suspicious: true },
    { timestamp: '02.08 21:20', lat: '37.4962', lng: '126.9461', speed: '0 km/h', location: '\u2605 봉천동 엔젤오피스텔 앞 (주차)', suspicious: true },
  ],
};
