...
const replacements = {
  ...
  'a|d-1|S5|empathy_approach#3': '제 아내 입장에서는 이유보다 배제된 장면이 먼저 남았을 겁니다. 저는 280만원 간병 예약금을 먼저 보내고 그 사실까지 숨기면서 관계의 신뢰를 깼습니다. 그 상처가 남은 건 당연하다고 생각합니다.',
  'a|d-1|S5|empathy_approach#5': '저는 돌봄을 준비했다는 말보다 아내가 느낀 상실감을 먼저 봐야 한다고 생각합니다. 280만원 예약금을 먼저 보낸 선택이 결국 비밀 송금으로 남으면서 신뢰를 깨뜨렸기 때문입니다. 그 정서적 손상까지 제가 안고 가겠습니다.',
  'a|d-2|S5|fact_pursuit#4': '새벽 열람과 캡처는 분명 잘못이었습니다. 그렇지만 그 행동을 부른 배경에 제가 감춰 둔 비밀과 설명 회피가 있었다는 점도 지워지지 않습니다. 저는 두 사실을 함께 인정합니다.',
  'a|d-2|S5|empathy_approach#4': '불안을 이해한다고 해서 사생활 경계까지 무너져도 된다고 말할 수는 없습니다. 제가 남긴 비밀이 원인이었고, 아내의 대응은 또 다른 상처가 됐습니다. 지금은 그 얽힌 책임을 함께 받아들이고 있습니다.',
}
