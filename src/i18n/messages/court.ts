...
export const courtMessages = {
  ...
  "zh-CN": {
    ...
    "pc.verdictAdvance.hidden.keepInvestigating": "继续询问",
    "pc.mediation.entry.eyebrow": "裁决",
    "pc.mediation.entry.title": "结束询问并进入裁决吗？",
    "pc.mediation.entry.body": "决定是继续询问，还是直接进入裁决。",
    ...
    "pc.mediation.entry.secondary": "继续询问",
    "pc.mediation.entry.primary": "进入裁决",
    "pc.mediation.entry.dialogue": "询问到此结束，进入裁决。",
  },
