...
export const courtMessages = {
  ko: {
    ...
    "pc.verdictAdvance.hidden.title": "미발견 쟁점 존재",
    "pc.verdictAdvance.hidden.subtitle": "판결 전 확인",
    "pc.verdictAdvance.hidden.body": "현재 드러난 쟁점은 {visible}개입니다. 아직 밝혀지지 않은 쟁점이 {hidden}개 남아 있습니다. 그래도 바로 판결을 진행하시겠습니까? 미발견 쟁점 존재 시, 판결에 제약이 있을 수 있습니다.",
    ...
    "pc.verdictAdvance.hidden.keepInvestigating": "추가 심문 진행",
  },
  en: {
    ...
    "pc.verdictAdvance.hidden.title": "Hidden Issues Remain",
    "pc.verdictAdvance.hidden.subtitle": "Before the Verdict",
    "pc.verdictAdvance.hidden.body": "{visible} issues are currently revealed. {hidden} issues remain hidden. Proceed to the verdict anyway? Unrevealed issues may limit the verdict.",
    ...
    "pc.verdictAdvance.hidden.keepInvestigating": "Continue Questioning",
  },
  ja: {
    ...
    "pc.verdictAdvance.hidden.title": "未発見の争点あり",
    "pc.verdictAdvance.hidden.subtitle": "判決前の確認",
    "pc.verdictAdvance.hidden.body": "現在明らかな争点は{visible}件です。まだ明らかになっていない争点が{hidden}件残っています。それでも判決へ進みますか？未発見の争点があると、判決に制約が生じる可能性があります。",
    ...
    "pc.verdictAdvance.hidden.keepInvestigating": "追加で尋問する",
  },
  "zh-CN": {
    ...
    "pc.verdictAdvance.hidden.body": "当前已揭示 {visible} 个争议点。仍有 {hidden} 个争议点尚未揭示。仍要直接进入判决吗？存在未发现的争议点时，判决可能会受到限制。",
    "pc.verdictAdvance.hidden.visibleTag": "已公开争议点 {count}",
    "pc.verdictAdvance.hidden.hiddenTag": "隐藏争议点 {count}",
    "pc.verdictAdvance.hidden.confirm": "进行判决",
