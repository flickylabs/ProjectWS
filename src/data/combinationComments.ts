...
const COMMENTS: Record<string, CombinationComment[]> = {
  ...
  'family-01': [
    ...
    { recipeId: 'combine-2', comment: '공증본과 서랍 원본의 비율 방향이 다릅니다. 왜 자기 몫을 줄였는지 물어야겠습니다.' },
    { recipeId: 'combine-3', comment: '원본 유서의 비율과 20년 송금이 이어집니다. 돈의 출처부터 다시 봐야 합니다.' },
    { recipeId: 'combine-4', comment: '송금 기록과 일기장이 맞물립니다. 침묵의 이유가 단순한 돈 문제를 넘어섭니다.' },
    ...
    { recipeId: 'combine-7', comment: '원본 유서와 어머니 일기장이 같은 방향을 가리킵니다. 감춘 이유를 따져야겠습니다.' },
    ...
    { recipeId: 'combine-10', comment: '상속 감정과 20년 송금 흐름이 맞물립니다. 누가 무엇을 떠안았는지 확인하겠습니다.' },
