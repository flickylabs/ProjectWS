...
const SPOUSE_01_OVERLAYS: CaseTestimonyOverlay = {
  ...
  ja: {
    ...
    "w1-d1-no-single-woman": {
      ...
      testimony: "いいえ、その階に女性が一人で暮らす家はありません。家族で住んでいる家がほとんどで、302号室は男性が一人で住んでいると認識しています。",
      topic: "その階の居住者構成について尋ねる",
    },
    "w1-d1-resident-info": {
      behaviorHint: "記憶をたどりながら",
      question: "イ・ジュノさんが訪問する階には、どのような方々が住んでいますか。",
      testimony: "その階はほとんどが家族世帯です。女性が一人で暮らす家はないと認識しています。",
    ...
    "w2-d2-cash-pattern": {
      ...
      testimony: "4か月にわたって分けて出金していました。500万、800万、700万、1,000万ウォンです。すべて同じ支店のATMで、振込を使わないのが少し珍しかったです。",
      topic: "出金パターンについて尋ねる",
    },
    "w2-d2-cash-withdrawal": {
    ...
    "w2-hd3-core": {
      ...
      testimony: "はい。数週間後に来られて、「積立預金を解約したことはない」と言いました。かなり驚いた表情でした。その時、私も「ああ、委任状が問題だったのか」と思いました。",
    ...
    "w2-hd3-signature-doubt": {
      ...
      testimony: "ご主人の元の署名はもう少しはっきりしたものですが、委任状の署名は崩して書いたように見えました。ただ、私は筆跡鑑定人ではないので確信はできませんでした。",
...
const FAMILY_01_OVERLAYS: CaseTestimonyOverlay = {
  en: {
    ...
    "w1-d2-before-brother-arrives": {
      ...
      testimony: "Yes. Mr. Yoon Jeong-hu said, “Let's finish before my older brother arrives.” But it felt less like greed and more like caution, as if he feared voices would rise again that day.",
    ...
    "w1-d3-avoid-conflict": {
      ...
      testimony: "From what I saw beside them, it was closer to avoiding conflict. When the older brother came, voices really did get louder, and each time their mother hunched her shoulders. So I saw the second son less as using his mother and more as trying to finish before she became frightened.",
      topic: "Ask about the actual atmosphere of the process",
    },
    "w2-d1-document-balance": {
      behaviorHint: "calmly",
      question: "Did the first document brought in and the document brought in again give different impressions?",
      testimony: "They did. The first one felt heavily tilted to one side, and the one submitted again looked a little more balanced.",
      topic: "Ask about the impression of the two documents",
    },
    "w2-d1-two-visits": {
      behaviorHint: "professionally and precisely",
      question: "Did the same person come to the office twice that day?",
      testimony: "Yes. The same person came twice on the same day, so I remember it. It is not common.",
      topic: "Ask whether the same person came twice on the same day",
    },
    "w2-d2-ratio-change": {
      behaviorHint: "clearly",
      question: "Explain that difference in numbers. How did it change?",
      testimony: "The first document was Yoon Jeong-hu 90 and Yoon Tae-seong 10. The second changed to Yoon Jeong-hu 60 and Yoon Tae-seong 40. Looking only at the numbers, he had resubmitted it after reducing his own share.",
    ...
    "w2-d2-same-submitter": {
      ...
      testimony: "Mr. Yoon Jeong-hu stood at the reception desk both times. He was also the one who took the documents back and brought them again.",
      topic: "Ask who resubmitted it",
    },
    "w2-d3-benefit-direction": {
      behaviorHint: "cautious but distinct",
      question: "When you saw that change, whose interest did you think the revision moved toward?",
      testimony: "At least it was not a revision meant to increase his own share. Speaking only from what I saw at the reception desk, Mr. Yoon Jeong-hu resubmitted a document lowering his ratio from 90 to 60. So to me, that day's revision looked less like greed and more like an adjustment to reduce the shock his brother would receive.",
      topic: "Ask whose interest the revision moved toward",
    },
    "w3-d1-living-support": {
      behaviorHint: "recalling calmly",
      question: "Did the mother say anything about money coming in regularly?",
      testimony: "She worried about money for a long time. Still, she once said she was getting by because the younger son sent money every month.",
      topic: "Ask about the regular support money",
    },
    "w3-d1-secret-burden": {
      behaviorHint: "speaking low",
      question: "Did the mother say there was something the older son must not know?",
      testimony: "Yes. She said several times that some matter had to remain unknown to that son until the end. Each time she said it, her expression was very heavy.",
      topic: "Ask about the remark that the older son must not know",
    },
    "w3-d2-money-nature": {
      behaviorHint: "pointing only to what she clearly remembers",
      question: "What did you hear that money was for? Who was helping whom with it?",
      testimony: "I heard it was money Mr. Yoon Jeong-hu sent every month to his mother's account. And when ₩300 million went out, their mother said directly that it was “money being sent toward Tae-seong's factory.”",
      topic: "Ask about the nature of that money",
    },
    "w3-d2-secret-reason": {
      behaviorHint: "cautiously",
      question: "Did you hear why the older son had to be kept from knowing?",
      testimony: "Their mother avoided exact words, but she said, “If Tae-seong learns that fact, it will break him.” She also said, “Jeong-hu is carrying that burden alone.”",
    ...
    "w3-d3-why-kept-secret": {
      ...
      testimony: "It was not the tone of a person hiding it to receive more inheritance. Their mother was the first to insist, “Tae-seong must never know,” and Mr. Yoon Jeong-hu was acting to keep his brother from collapsing, just as she asked. So I saw the center of this family as closer to a birth secret and guilt than to a fight over money.",
