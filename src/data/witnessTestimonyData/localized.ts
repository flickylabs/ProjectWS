...
const FAMILY_01_OVERLAYS: CaseTestimonyOverlay = {
  ...
  ja: {
    ...
    "w1-d2-before-brother-arrives": {
      ...
      testimony: "ありました。ユン・ジョンフさんが「兄さんが来る前に終わらせよう」と言いました。ただ、その言葉は、また大きな声にならないよう慎重になっている感じに近かったです。",
    ...
    "w1-d3-avoid-conflict": {
      ...
      testimony: "私がそばで見た限りでは、争いを避けようとしている側でした。お兄様が来ると実際に声が大きくなり、そのたびにお母様は肩をすくめていました。だから私は、次男がお母様を怖がらせないよう守ろうとしていたのだと感じました。",
      topic: "その過程の実際の雰囲気を尋ねる",
    },
    "w2-d1-document-balance": {
      behaviorHint: "落ち着いて",
      question: "最初に作成した書類と、作成し直した書類の内容は違いましたか。",
      testimony: "違いました。最初の書類と二度目の書類では内容が違いました。息子さんたちの相続比率が変更されていました。",
      topic: "二つの書類の内容差を尋ねる",
    },
    "w2-d1-two-visits": {
      behaviorHint: "業務的に正確に",
      question: "同じ日に二度訪問することになったのですか。",
      testimony: "はい。作成を終えたあと、もう一度来てほしいと頼まれ、同じ日の夕方に再訪問しました。よくあることではありません。",
      topic: "同じ日に二度訪問した経緯を尋ねる",
    },
    "w2-d2-ratio-change": {
      behaviorHint: "はっきりと",
      question: "それでも大きく疑わなかった理由は何ですか。",
      testimony: "ただ、疑わなかったのは、二つ目の書類よりも最初の書類の内容のほうが少し不自然に感じられたからです。だから、より一般的な水準に直されたのだろうと思っただけでした。",
      topic: "疑わなかった理由を尋ねる",
    },
    "w2-d2-same-submitter": {
      behaviorHint: "記憶が鮮明であるかのように",
      question: "二度目に訪問したとき、お母様の状態はどう見えましたか。",
      testimony: "実は二度目に伺ったときは、お母様の状態がよく見えませんでした。ほんの午前中にお会いしたばかりなのに、私を覚えていらっしゃらなかったんです。",
      topic: "二度目の訪問時のお母様の状態を尋ねる",
    },
    "w2-d3-benefit-direction": {
      behaviorHint: "慎重だが明瞭に",
      question: "公証の場で、ユン・ジョンフさんが答えを誘導しているように見えた場面はありましたか。",
      testimony: "正直、ユン・ジョンフさんが、記憶が曖昧なお母様に答えを誘導しているようには感じました。ただ、大きく疑わなかったのは、ユン・ジョンフさんご自身の比率をわざわざ下げる方はいないだろうと思ったからです。ですから、あらかじめ合意された内容なのだろうと考えました。",
      topic: "答えの誘導と疑わなかった理由を尋ねる",
    },
    "w3-d1-living-support": {
      behaviorHint: "落ち着いて思い出しながら",
      question: "母は定期的に入ってくるお金について何か話していましたか。",
      testimony: "お金の心配を長くされていました。それでも、下の息子が毎月仕送りしてくれるから持ちこたえている、とおっしゃっていました。",
      topic: "定期支援金の事情を尋ねる",
    },
    "w3-d1-secret-burden": {
      behaviorHint: "低く話しながら",
      question: "何か、最後まで知らないほうがいいことがあると話していましたか。",
      testimony: "ありました。あることは最後まで知らないでいたほうがいいと、何度もおっしゃっていました。それで、それが一体何なのかと聞いても、話してはくれませんでした。",
      topic: "最後まで知らないほうがいいという言葉を尋ねる",
    },
    "w3-d2-money-nature": {
      behaviorHint: "はっきり覚えている部分だけを指摘しながら",
      question: "そのお金について、どんな話を聞きましたか。",
      testimony: "上の息子の工場が大変で大ごとだと言っていたのに、しばらくして幸い解決したとおっしゃいました。それで、どう解決したのか聞くと、立派に育てた息子のおかげだとだけ言っていました。",
      topic: "工場危機と解決の話を尋ねる",
    },
    "w3-d2-secret-reason": {
      behaviorHint: "慎重に",
      question: "長男が知らないでいなければならない理由を聞いたことはありますか。",
      testimony: "正確に話したことはありませんが、「上の子は自尊心が強いから、事実を知ったら崩れてしまう」と言っていました。それから「下の子がすべての荷を一人で背負っている」ともおっしゃっていました。",
      topic: "なぜ隠さなければならなかったのかを尋ねる",
    },
    "w3-d3-why-kept-secret": {
      behaviorHint: "重く、しかし揺らがずに",
      question: "証人が聞いたことを総合すると、ユン・ジョンフさんはなぜその秘密を隠したのだと思いますか。",
      testimony: "ただ二人の息子のことを心配しているだけでした。上の息子が事業に執着するのは、もしかすると兄ご自身が父の実子ではないことに気づいて、成功に固執しているのではないかと心配されていました。それに、下の息子から受け取ったお金まで全部上の息子へ送っていたので、せめて遺産は下の息子に返してやらなければならない、と話したことがあります。",
  ...
  "zh-CN": {
    ...
    "w1-d2-before-brother-arrives": {
      ...
      testimony: "有。尹正厚先生说过：“在哥哥来之前结束吧。”不过那句话更像是担心那天又会吵起来，所以格外小心。",
      topic: "询问“结束吧”这句话的语境",
    },
    "w1-d2-clarity-fluctuation": {
    ...
    "w1-d3-avoid-conflict": {
      ...
      testimony: "就我在旁边看到的情况，更接近于避免争吵。哥哥一来，声音确实会变大，每次母亲都会缩起肩膀。所以我觉得二儿子是想保护母亲，不让她受惊。",
      topic: "询问那个过程的实际气氛",
    },
    "w2-d1-document-balance": {
      behaviorHint: "冷静地",
      question: "第一次制作的文件和后来重新制作的文件，内容有不同吗？",
      testimony: "有不同。第一份文件和第二份文件的内容不一样，两个儿子的继承比例改了。",
      topic: "询问两份文件的内容差异",
    },
    "w2-d1-two-visits": {
      behaviorHint: "业务性而准确地",
      question: "那天您到同一家里访问过两次吗？",
      testimony: "是的。他们写完后又来找我，所以我当天晚上再次上门访问了。这并不常见。",
      topic: "询问同一天两次上门访问的事实",
    },
    "w2-d2-ratio-change": {
      behaviorHint: "明确地",
      question: "看到两份文件的比例变化时，您没有起疑吗？",
      testimony: "不过我没有怀疑，是因为第一份文件的内容比第二份更让我觉得有点奇怪。所以我只是以为他们改成了更一般的水平。",
      topic: "询问对比例变化的印象",
    },
    "w2-d2-same-submitter": {
      behaviorHint: "像是记忆很清晰",
      question: "第二次访问时，母亲的状态如何？",
      testimony: "其实第二次去见她时，母亲的状态看起来不太好。上午才见过我，到了晚上却已经不记得我了。",
      topic: "询问第二次访问时母亲的状态",
    },
    "w2-d3-benefit-direction": {
      behaviorHint: "谨慎但清楚地",
      question: "在那个变更过程中，证人当时的印象是什么？",
      testimony: "说实话，我感觉尹正厚先生像是在引导记忆不太清楚的母亲回答。但我没有太怀疑，因为他不会故意降低自己的份额吧？所以我以为那是他们事先商量好的内容。",
      topic: "询问修改过程给证人的印象",
    },
    "w3-d1-living-support": {
      behaviorHint: "平静回想地",
      question: "母亲有没有说过定期进来的钱？",
      testimony: "她长期担心钱。不过她说过，因为小儿子每个月给的零用钱，才能撑下去。",
      topic: "询问定期支援金的情况",
    },
    "w3-d1-secret-burden": {
      behaviorHint: "低声地",
      question: "母亲有没有说过，有件事大儿子不能知道？",
      testimony: "有。她说过好几次，有些事必须到最后都不知道。所以我问那到底是什么，她也没有告诉我。",
      topic: "询问“大儿子不能知道”的话",
    },
    "w3-d2-money-nature": {
      behaviorHint: "只指出清楚记得的部分",
      question: "您听说过大儿子工厂的情况吗？",
      testimony: "她说大儿子的工厂困难，出了大事。没过多久又说幸好解决了。我问她是怎么解决的，她只说多亏自己把儿子养得好。",
      topic: "询问大儿子工厂危机和解决经过",
    },
    "w3-d2-secret-reason": {
      behaviorHint: "谨慎地",
      question: "您听过为什么不能让大儿子知道吗？",
      testimony: "她没有说得很明确，但说过：“老大自尊心强，如果知道事实，人会垮掉。”她也说过：“老二一个人背着所有负担。”",
      topic: "询问为什么必须隐瞒",
    },
    "w3-d3-why-kept-secret": {
      behaviorHint: "沉重但不动摇地",
      question: "母亲平时对两个儿子有什么担心？",
      testimony: "她只是担心两个儿子。她担心大儿子一直执着于事业，是不是察觉到自己不是父亲亲生的，所以才拼命追求成功；又因为连从小儿子那里收到的钱都全给了大儿子，她说过至少遗产也该还给小儿子。",
      topic: "询问母亲对两个儿子的担心",
    },
  },
}
...
const FRIEND_01_OVERLAYS: CaseTestimonyOverlay = {
  en: {
    "w1-d1-chat-mood": {
      ...
      testimony: "At first, everyone was shocked. Since all they could see was the number of contacts, honestly, I also thought Sumin had crossed the line.",
    ...
    "w1-d1-frame-wording": {
      ...
      testimony: "She did not simply post the record. The talk spread as if this had happened before too. That made the atmosphere lean even more to one side.",
    ...
    "w1-d2-blame-spread": {
      ...
      testimony: "It happened within minutes. Once Daeun posted, \"Sumin is contacting my man again,\" comments like \"Why is she doing this when she is about to get married?\" poured out immediately.",
    ...
    "w1-d2-no-one-checked": {
      ...
      testimony: "No. Everyone looked at the screenshot and immediately took sides. I was also pressed by the mood then and could not contact her separately.",
    ...
    "w1-d3-first-conclusion": {
      ...
      testimony: "The order was clear. Everyone judged the situation only from Daeun's story, and her words became the standard in the group chat. No one listened to Sumin's side.",
    ...
    "w2-d1-contact-reaction": {
      ...
      testimony: "Outwardly, he acted like it was a nuisance. But he looked closer to someone uncomfortable than someone angry because he had been wronged.",
    ...
    "w2-d2-flirt-remark": {
      ...
      testimony: "He said things like, \"That Pilates friend is pretty nice,\" and \"If she weren't Daeun's friend, I would have hit on her by now.\" It was not something an engaged man should say.",
    ...
    "w2-d2-why-looked-caught": {
      ...
      testimony: "He once said to me offhand, \"I shouldn't have stirred this up; it blew up.\" That is why I do not think Ms. Choi Su-min's contact suddenly began out of nowhere.",
    ...
    "w2-d3-rejection-ignored": {
      ...
      testimony: "Yes. He once showed me his phone and laughed it off, saying, \"She says I shouldn't do this because I'm her friend's boyfriend.\" Even after receiving a rejection, he said, \"She's playing hard to get. She'll come around in the end.\" What I saw was not Ms. Choi Su-min's obsession, but my senior's casual pushiness.",
    ...
    "w3-d2-father-identity": {
      ...
      question: "Did you later find out who that older man was?",
      testimony: "I later learned he was Ms. Song Da-eun's father. A few days later, I asked Daeun if he had stopped coming by lately and whether something had happened, and she only said briefly, \"Sumin and I cut ties.\"",
    ...
    "w3-d2-overheard-phrase": {
      ...
      testimony: "Yes. The older man said, \"Please help me just one more time.\" The younger woman said, \"Why are you doing this to me?\" It did not sound like it had happened only once or twice.",
      topic: "Ask what was said before she cried",
    },
    "w3-d3-breakup-cause": {
      behaviorHint: "careful but firm",
      question: "Based on what you saw that day, what did the cause of the earlier fallout seem closer to?",
      testimony: "What I saw was a money problem. Ms. Song Da-eun's father seemed to have made an unreasonable request of Ms. Choi Su-min, and Ms. Choi Su-min seemed to have broken down alone. I think the problem was on the father's side, not between the two friends.",
  ...
  ja: {
    "w1-d1-chat-mood": {
      ...
      testimony: "最初はみんな驚きました。連絡回数だけが見えていたので、正直、私もスミンが一線を越えたのだと思いました。",
      topic: "グループチャットの雰囲気を尋ねる",
    },
    "w1-d1-frame-wording": {
      behaviorHint: "記憶を探りながら",
      question: "ソン・ダウンさんはそのスクリーンショットを上げる時、どのように説明しましたか。",
      testimony: "ただ記録だけを上げたのではなく、以前にもずっと似たようなことがあったというふうに話が広がりました。それで雰囲気がさらに一方に傾きました。",
      topic: "最初についた言葉の方向を尋ねる",
    },
    "w1-d2-blame-spread": {
      behaviorHint: "もどかしそうに",
      question: "その言葉がついた後、非難はどれくらい早く広がりましたか。",
      testimony: "数分のうちに起きました。ダウンが「スミンが私の男にまた連絡している」と投稿すると、すぐに「結婚を控えているのに、なぜまたあんなことをするのか」という言葉があふれました。",
      topic: "非難が広がった速さを尋ねる",
    },
    "w1-d2-no-one-checked": {
      behaviorHint: "申し訳なさそうに",
      question: "その後、チェ・スミンさんに直接事情を聞いた人はいましたか。",
      testimony: "いませんでした。みんなスクリーンショットを見てすぐに立場を決めました。私もその時は雰囲気に押されて、個別に連絡できませんでした。",
      topic: "直接確認した人がいたか尋ねる",
    },
    "w1-d3-first-conclusion": {
      behaviorHint: "申し訳なさを込めて断固と",
      question: "証人の基準で答えてください。その日、誰が先に結論を作ってしまいましたか。",
      testimony: "順序ははっきりしていました。ダウンの話だけで状況を判断し、その言葉がグループチャットの基準になってしまいました。スミンの話は誰も聞きませんでした。",
    ...
    "w2-d2-flirt-remark": {
      ...
      testimony: "先輩は「あのピラティスをしている友達、いいよな」「ダウンの友達じゃなかったら、とっくに口説いていただろうに」と言っていました。婚約している人が言うことではありませんでした。",
      topic: "具体的に何を言ったか尋ねる",
    },
    "w2-d2-why-looked-caught": {
      behaviorHint: "小さくため息をつきながら",
      question: "なぜそう見えたのか、聞いた言葉を基準に説明してください。",
      testimony: "先輩が私に「余計なことに下手に手を出して、事が大きくなった」というようにぽろっと言ったことがあります。だから私は、チェ・スミンさんの連絡が突然始まったわけではないと思いました。",
      topic: "なぜ見つかった人のように見えたか尋ねる",
    },
    "w2-d3-rejection-ignored": {
      behaviorHint: "不快だった記憶を取り出しながら",
      question: "証人の判断ではなく、見た場面で答えてください。先輩が先に一線を越えたと見られる事情はありましたか。",
      testimony: "ありました。先輩が携帯を見せながら、「友達の彼氏だからこういうことはやめろってさ」と笑い流したことがあります。拒絶の返信を受けても、「気取って跳ね返してる。結局は落ちてくるくせに」と言っていました。私が見たのはチェ・スミンさんの執着ではなく、先輩側の軽い押しでした。",
    ...
    "w3-d2-father-identity": {
      behaviorHint: "困ったように",
      question: "その年配の男性が誰だったか、後で分かりましたか。",
      testimony: "後で聞いて、ダウンさんのお父様だと分かりました。数日後、私がダウンさんに、最近よく来られないけれど何かあったのかと尋ねると、「スミンとは絶交した」とだけ短く言いました。",
      topic: "その男性が誰だったか尋ねる",
    },
    "w3-d2-overheard-phrase": {
      behaviorHint: "低い声で",
      question: "泣く前にどんな言葉が交わされたか、聞いたことはありますか。",
      testimony: "はい。その年配の男性が「もう一度だけ助けてほしい」と言いました。その若い方は「どうして私にそんなことをするんですか」と言っていました。一度や二度のことではなさそうでした。",
      topic: "泣く前に聞いた言葉を尋ねる",
    },
    "w3-d3-breakup-cause": {
      behaviorHint: "慎重だが断固として",
      question: "その日の場面を基準に見ると、過去の絶縁原因は何に近く見えましたか。",
      testimony: "私が見たのはお金の問題でした。ダウンさんのお父様がスミンさんに無理な頼みをしたようで、スミンさんは一人で崩れていたように見えます。これは二人の友人の問題ではなく、お父様側に問題があったと思います。",
      topic: "過去の絶縁原因を尋ねる",
    },
  },
  "zh-CN": {
    "w1-d1-chat-mood": {
      ...
      testimony: "一开始大家都吓了一跳。因为只看得到联系次数，说实话，我也以为秀敏越线了。",
      topic: "询问群聊气氛",
    },
    "w1-d1-frame-wording": {
      behaviorHint: "一边回忆一边说",
      question: "宋多恩女士发那张截图时，是怎么说明的？",
      testimony: "她不是只把记录发上来而已，话很快变成了“以前也一直这样”。所以气氛更往一边倒了。",
      topic: "询问最初定性的说法",
    },
    "w1-d2-blame-spread": {
      behaviorHint: "感到憋闷",
      question: "贴上那个说法后，指责扩散得有多快？",
      testimony: "几分钟内就发生了。多恩一发“秀敏又在联系我男人”，马上就有人说“都快结婚了，怎么又这样”。",
      topic: "询问指责扩散速度",
    },
    "w1-d2-no-one-checked": {
      behaviorHint: "带着歉意",
      question: "之后有人直接问过崔秀敏女士事情经过吗？",
      testimony: "没有。大家一看截图就马上站队了。我那时候也被气氛压住，没能另外联系她。",
      topic: "询问是否有人直接确认",
    },
    "w1-d3-first-conclusion": {
      behaviorHint: "带着歉意但坚定",
      question: "请按证人的判断回答。那天是谁先制造了结论？",
      testimony: "顺序很清楚。大家只听多恩的说法就判断了情况，那句话成了群聊里的标准。没有人听秀敏怎么说。",
      topic: "询问谁先制造结论",
    },
    "w2-d1-after-work-talk": {
      behaviorHint: "谨慎地",
    ...
    "w2-d1-contact-reaction": {
      ...
      testimony: "表面上像是嫌麻烦。但比起被冤枉后发火的人，他更像是不自在。",
      topic: "询问联系问题后的反应",
    },
    "w2-d2-flirt-remark": {
      behaviorHint: "不赞同地",
      question: "你说他有好感，具体他说了什么？",
      testimony: "前辈说过“那个练普拉提的朋友挺不错”“要不是多恩的朋友，我早就追了她”之类的话。那不是订婚的人该说的话。",
      topic: "询问具体说过什么",
    },
    "w2-d2-why-looked-caught": {
      behaviorHint: "轻轻叹气",
      question: "请根据你听到的话说明，为什么你会这样看。",
      testimony: "前辈曾经随口跟我说过：“我不该随便去招惹，结果把事情闹大了。”所以我认为，崔秀敏的联系不是突然开始的。",
      topic: "询问为什么像被抓到的人",
    },
    "w2-d3-rejection-ignored": {
      behaviorHint: "说起令人不快的记忆",
      question: "不要说判断，请按你看到的场面回答。有没有情况显示你的前辈先越界？",
      testimony: "有。前辈曾经给我看手机，笑着说：“她说我是朋友的男朋友，叫我别这样。”收到拒绝回复后，他还说“故意装清高拒人。她迟早会松口的。”我看到的不是崔秀敏的执着，而是前辈那边轻率的靠近。",
      topic: "询问被拒后是否仍越界",
    },
    "w3-d1-crying-scene": {
      behaviorHint: "谨慎回想",
    ...
    "w3-d2-father-identity": {
      ...
      testimony: "后来听说才知道是多恩的父亲。几天后我问多恩最近怎么不常来、是不是出了什么事，她只短短说了一句：“我和秀敏断交了。”",
      topic: "询问那个男人是谁",
    },
    "w3-d2-overheard-phrase": {
      behaviorHint: "低声说",
      question: "她哭之前，你听到他们说了什么吗？",
      testimony: "听到了。那位年长男性说：“再帮我一次就好。”那位年轻女子说：“为什么要这样对我？”听起来不像只有一两次。",
      topic: "询问她哭前听到的话",
    },
    "w3-d3-breakup-cause": {
      behaviorHint: "谨慎但坚定",
      question: "以那天的场面来看，过去断交的原因更接近什么？",
      testimony: "我看到的是钱的问题。多恩的父亲似乎向秀敏提出了过分的请求，秀敏像是一个人被压垮了。我认为这不是两个朋友之间的问题，而是父亲那边的问题。",
      topic: "询问过去断交的原因",
    },
  },
}
