  ...
  'spouse-01': {
    'd-2': {
      ...
      variants: [
        ...
        {
          tone: 'attack',
          text: '박지연 씨가 저를 딴 살림처럼 몰아갔지만, 제 돈이 어디로 갔는지도 따져봐야 합니다. 2,000만원은 제 개인 비자금이었고, 형 사정 때문에 현금으로 전한 겁니다.',
    ...
    'h-d3': {
      ...
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 저도 돈 얘기에서 떳떳하지 못합니다. 이준호 씨 명의 위임장을 제가 손댔고, 공동 적금 3,000만원을 해지했습니다.',
          behaviorHint: '박지연은 입술을 깨물고 두 손을 무릎 위에 꽉 쥔다.',
        },
        {
          tone: 'attack',
          text: '이준호 씨가 형에게 2,000만원을 숨긴 일만 보면 안 됩니다. 제가 공동 적금에 손댄 것도 잘못이지만, 그 사람이 먼저 돈을 숨겼다는 점도 봐주셔야 합니다.',
    ...
    'h-d4': {
      ...
      variants: [
        ...
        {
          tone: 'attack',
          text: '그래도 시작은 이준호 씨였습니다. 형 사정과 비자금 2,000만원을 숨긴 사람이 먼저 있었고, 그 뒤에 저도 무너진 겁니다.',
          behaviorHint: '박지연은 손등으로 눈가를 문지르며 억울함과 죄책감 사이에서 흔들린다.',
        },
        {
          tone: 'resignation',
          text: '…누가 먼저였는지 따지는 것도 결국 다 나와야겠죠. 숨긴 건 이준호 씨가 먼저였고, 감시와 위임장 조작은 제가 한 일입니다.',
  ...
  'family-01': {
    'd-2': {
      ...
      variants: [
        ...
        {
          tone: 'attack',
          text: '형은 제가 욕심을 부렸다고 몰아붙이지만, 실제로는 제 몫을 줄인 겁니다. 그렇다고 유서를 고친 죄가 사라지는 건 아닙니다.',
  ...
  'friend-01': {
    'd-2': {
      ...
      variants: [
        ...
        {
          tone: 'attack',
          text: '송다은 씨는 제가 결혼을 망치려 했다고만 말하지만, 먼저 접근한 건 예비신랑이었습니다. 그 메시지를 빼고 제 연락만 보면 안 됩니다.',
    ...
    'd-3': {
      ...
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 제가 송다은 씨에게 직접 말하지 못한 건 제 잘못입니다. 송다은 씨 아버지가 예비신랑에게 돈 얘기를 꺼내고 있었고, 저는 그 패턴을 알고 있었습니다.',
          behaviorHint: '최수민은 말을 고르느라 잠시 눈을 내리깐다.',
        },
        {
          tone: 'attack',
          text: '송다은 씨는 제가 결혼을 흔들려고 했다고 하지만, 아버지가 또 돈 문제로 접근하는 걸 보고도 가만히 있을 수는 없었습니다. 제가 본 건 집착이 아니라 반복되는 패턴이었습니다.',
    ...
    'd-4': {
      ...
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 제가 손절당할 때도 끝까지 말하지 못한 게 있습니다. 송다은 씨 아버지가 투자 명목으로 제 돈을 가져갔고, 저는 그걸 사기라고 말할 용기가 없었습니다.',
          behaviorHint: '최수민은 무표정에 가까운 얼굴로, 그러나 아주 천천히 말을 꺼낸다.',
        },
        {
          tone: 'attack',
          text: '송다은 씨는 제가 이유 없이 멀어졌다고 했지만, 진짜 이유는 송다은 씨 아버지의 사기였습니다. 제가 악역이 된 건 그 말을 차마 못 했기 때문입니다.',
          behaviorHint: '최수민은 억울함을 삼키듯 잠시 입을 다문 뒤 말을 잇는다.',
        },
        {
          tone: 'resignation',
          text: '…이 얘기까지 하면 송다은 씨도 무너질까 봐 숨겼습니다. 손절의 시작은 제 변덕이 아니라 아버지의 돈 문제였습니다.',
    ...
    'd-5': {
      ...
      variants: [
        ...
        {
          tone: 'attack',
          text: '하지만 최수민 씨도 늘 설명 대신 침묵을 택했습니다. 제가 단정한 건 잘못이지만, 그렇게 혼자 악역처럼 굴면 누가 믿을 수 있겠습니까?',
