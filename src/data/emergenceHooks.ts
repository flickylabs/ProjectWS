...
const HOOKS: Record<string, Record<string, EmergenceHook>> = {
  ...
  'family-01': {
    'd-2': {
      name: '공증 유서와 별도 문서의 차이',
      speaker: 'b',
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 공증본만으로는 전체 경위를 설명할 수 없습니다. 별도 자필 문서와 공증 당일 메모를 함께 봐야 합니다.',
        ...
        {
          tone: 'resignation',
          text: '…이제는 말해야겠습니다. 공증본의 숫자와 별도로 남은 문서가 있습니다. 제가 손댄 경위도 피하지 않겠습니다.',
    ...
    'd-3': {
      ...
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 이제는 어머니 통장을 거친 돈의 출처와 전달 순서를 확인해야 합니다. 제가 계속 입을 다문 것도 잘못입니다.',
          behaviorHint: '윤정후는 담담한 표정을 유지하지만 숨을 길게 내쉰다.',
        },
        {
          tone: 'attack',
          text: '형이 어머니를 평생 혼자 모셨다는 말만으로는 다 설명이 안 됩니다. 어머니 통장을 거친 흐름을 따로 봐야 합니다.',
          behaviorHint: '윤정후는 처음으로 윤태성 쪽을 똑바로 보며 목소리에 힘을 싣는다.',
        },
        {
          tone: 'resignation',
          text: '…그 돈 얘기까지 나오면 더는 숨길 수 없습니다. 월 단위 입금과 큰돈이 지나간 순서를 같이 봐야 합니다.',
    ...
    'd-4': {
      ...
      variants: [
        {
          tone: 'confession',
          text: '재판관님, 제가 유언장에 손댄 건 단순히 돈 때문만은 아니었습니다. 어머니 기록에 남은 민감한 사정까지 함께 봐야 합니다.',
          behaviorHint: '윤정후는 한참 침묵한 뒤, 감정을 누른 목소리로 말한다.',
        },
        {
          tone: 'attack',
          text: '형은 제가 어머니를 이용했다고만 하지만, 제가 왜 말을 막았는지도 봐야 합니다. 그 일기장에 남은 가족 사정이 있습니다.',
          behaviorHint: '윤정후는 차갑게 보일 만큼 차분하지만 눈가가 굳어 있다.',
        },
        {
          tone: 'resignation',
          text: '…그 기록은 끝까지 안 나오길 바랐습니다. 형이 그걸 어떻게 받아들일지 몰라서 제가 침묵했습니다.',
