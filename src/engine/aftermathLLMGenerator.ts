...
줄바꿈 후 후일담 전체를 관통하는 짧은 교훈 한 문장. 교훈은 반드시 큰따옴표로 감싼 별도 문단으로 작성하세요. 명언처럼 간결하되, 이 사건의 핵심 행동이나 관계에서 나온 말이어야 합니다.
예: "숨긴 마음은 보호가 아니라 다음 상처의 시작이었다."
...
- **과도한 교훈**: 마지막 교훈 문장은 1개만. 25~45자 안팎의 짧은 명언처럼 쓰되, 공허한 구호가 아니라 이 사건의 핵심에서 나온 말이어야 함.
