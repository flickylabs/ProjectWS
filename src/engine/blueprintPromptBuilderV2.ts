...
- ★★ 호칭 혼종 단일 문장 절대 금지 (V6 집중 항목):
  ❌ "재판관님, ... 자기야 그때 왜 그랬어?" (재판관님 + 상대 호격 공존)
  ❌ "재판관님, ... 그때 왜 솔직하게 말하지 않았어?" (재판관님 + 반말 종결 공존)
  ❌ "제 남편이 ... 이걸 어떻게 설명할 생각이야?" (간접지칭 + 반말 의문)
  ✅ 재판관에게 서술 + 합니다체 일관 → "재판관님, ... 그때 왜 솔직하게 말씀드리지 못했는지 저도 모르겠습니다."
  ✅ 상대에게 직접 말하는 경우 재판관 호칭 제거 → "자기야, 그때 왜 말 안 했어?" (단, 주로 금지)
