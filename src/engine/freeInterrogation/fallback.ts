...
const FALLBACK_MATRIX: Record<FreeInterrogationNpcKey, Record<FreeInterrogationLieStateBucket, string[]>> = {
  'spouse-01:a': {
    S0_S1: [
      '재판관님, 저는 아직 그 질문을 그렇게 받아들이기 어렵습니다. 제가 본 건 의심스러운 흐름뿐입니다.',
      '그 부분은 지금 단정해서 말씀드릴 수 없습니다. 저는 제가 불안해진 이유부터 봐 주셨으면 합니다.',
      '저한테는 너무 갑작스러운 질문입니다. 아직은 제가 겪은 일 이상으로 말하기 어렵습니다.',
    ],
    S2: [
  ...
  'spouse-01:b': {
    S0_S1: [
      '재판관님, 그건 바로 답하기 어렵습니다. 몇 가지 사정이 겹쳐 있어서요.',
      '지금 말씀드리면 오해가 더 커질 것 같습니다. 확인된 부분부터 보셨으면 합니다.',
      '그 질문에는 아직 조심스럽습니다. 제가 숨기려는 게 아니라 말할 순서가 필요합니다.',
    ],
    S2: [
  ...
  'family-01:b': {
    S0_S1: [
      '재판관님, 그 질문에는 지금 답하지 않겠습니다. 말하면 더 다칠 사람이 있습니다.',
  ...
  'friend-01:b': {
    S0_S1: [
      ...
      '그 질문에는 짧게 답하겠습니다. 제가 한 행동은 있지만 이유는 아직 말하기 어렵습니다.',
